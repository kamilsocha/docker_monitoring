...
public class ImageController {
    ...
    @PostMapping("/pull")
    public ResponseEntity<?> pull(@RequestParam String name, @RequestParam(required = false, defaultValue = "latest") String tag, @RequestParam(required = false, defaultValue = "30") Long awaitCompletion) throws InterruptedException {
        var result = imageService.pullImage(name, tag, awaitCompletion);
